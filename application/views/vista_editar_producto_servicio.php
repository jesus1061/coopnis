  <?php
  $item_id = $_SESSION['producto_editar'];
  include_once "application/controllers/admin/archivos/listar_archivos.php";
  include_once "application/controllers/admin/comercial/editar_producto_servicio.php";
  ...
  <head>
    ...
    <title>Editar Productos y/ servicios</title>
          ...
          <section class="wrapper">
            <div class="row mt">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="message"></div>
                <form class="contact-form php-mail-form" role="form" action="../controlador_comercial/editar_producto_servicio" method="POST">
                  <?php
                  while ($row = $consultar_producto_servicio->fetch()) {
                    echo '
                    <div class="form-group" style="display:none">
                    <input type="name" name="item_id" class="form-control" value="'.$row['item_id'].'"  placeholder="id Del programa" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required readonly >
                    <div class="validate"></div>
                    </div>
                     <div class="form-group">
                    <input type="name" name="item_nombre" class="form-control" value="'.$row['item_nombre'].'"  placeholder="Nombre del producto o servicio" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                    </div>
                    <div class="form-group">
                    <input type="name" name="item_desc" class="form-control" value="'.$row['item_desc'].'"  placeholder="Descripción del producto o servicio" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                    </div>
                   
                    <div class="form-group">
                    <input type="text" name="item_foto" class="form-control" value="'.$row['item_foto'].'" id="abrir_archivos" placeholder="Escoga aqui la foto para describir el producto o servicio" readonly style="cursor: pointer" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                    <div class="validate"></div>
                    </div>
                    ';
                  }
                ...
                <div class="form-send">
                  <button type="submit" class="btn btn-large btn-primary">Editar Producto/servicio</button>
                </div>
