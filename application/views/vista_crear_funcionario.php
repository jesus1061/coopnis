          ...
          <section class="wrapper">
            <div class="row mt">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="message"></div>
                <form class="contact-form php-mail-form" role="form" action="../controlador_funcionario/crear_funcionario" method="POST">

                  <div class="form-group">
                    <input type="name" name="personal_nombre" class="form-control" id="contact-name" placeholder="Nombre Del funcionario" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                    <input type="name" name="personal_cargo" class="form-control" id="contact-name" placeholder="cargo Del funcionario" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                    <input type="name" name="link_facebook" class="form-control" id="contact-name" placeholder="Link facebook" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                    <input type="name" name="link_instagram" class="form-control" id="contact-name" placeholder="Link instagram" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                    <input type="name" name="link_twitter" class="form-control" id="contact-name" placeholder="Link twitter" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                  </div>

                  <div class="form-group">
                    <input type="text" name="personal_foto" class="form-control" id="abrir_archivos" placeholder="Escoga aqui el la foto del perfil" readonly style="cursor: pointer" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                    <div class="validate"></div>
                  </div>
