          ...
          <section class="wrapper">
            <div class="row mt">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="message"></div>
                <form class="contact-form php-mail-form" role="form" action="../controlador_comercial/crear_producto_servicio" method="POST">

                  <div class="form-group">
                    <input type="name" name="item_nombre" class="form-control" id="contact-name" placeholder="Nombre Del Producto o servicio" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                    <input type="name" name="item_desc" style="height: 100px;" class="form-control" id="contact-name" placeholder="Descripcion corta del producto o servicio" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                  </div>

                  <div class="form-group">
                    <input type="text" name="item_foto" class="form-control" id="abrir_archivos" placeholder="Escoga aqui la Foto del producto o servicio" readonly style="cursor: pointer" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                    <div class="validate"></div>
                  </div>
                ...
                <div class="sent-message">Has creado un producto o servicio con exito!</div>

                <div class="form-send">
                  <button type="submit" class="btn btn-large btn-primary">Crear Producto o servicio</button>
                </div>
