  <?php
  $programa_id = $_SESSION['programa_editar'];
  include_once "application/controllers/admin/archivos/listar_archivos.php";
  include_once "application/controllers/admin/programas/editar_programa.php";
          ...
          <section class="wrapper">
            <div class="row mt">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="message"></div>
                <form class="contact-form php-mail-form" role="form" action="../controlador_programa/editar_programa" method="POST">
                  <?php
                  while ($row = $consultar_programa->fetch()) {
                    echo '
                    <div class="form-group" style="display:none">
                    <input type="name" name="programa_id" class="form-control" value="'.$row['programa_id'].'"  placeholder="id Del programa" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required readonly >
                    <div class="validate"></div>
                    </div>
                     <div class="form-group">
                    <input type="name" name="titulo_programa" class="form-control" value="'.$row['titulo_programa'].'"  placeholder="Titulo del programa" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                    </div>
                    <div class="form-group">
                    <input type="name" name="contenido_programa" class="form-control" value="'.$row['contenido_programa'].'"  placeholder="Contenido del programa" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                    </div>
                   
                    <div class="form-group">
                    <input type="text" name="portada_programa" class="form-control" value="'.$row['portada_programa'].'" id="abrir_archivos" placeholder="Escoga aqui el banner" readonly style="cursor: pointer" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                    <div class="validate"></div>
                    </div>
                    ';
                  }
