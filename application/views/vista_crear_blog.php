          ...
          <section class="wrapper">
            <div class="row mt">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="message"></div>
                <form class="contact-form php-mail-form" role="form" action="../controlador_blog/crear_blog" method="POST">

                  <div class="form-group">
                    <input type="name" name="titulo_pub" class="form-control" id="contact-name" placeholder="Titulo de la publicación" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                  ...
                  <div class="form-group">
                    <input type="name" name="contenido_pub" class="form-control" id="contact-name" placeholder="Contenido de la publicación" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required style="height: 100px;" >
                    <div class="validate"></div>
                  </div>

                  <div class="form-group">
                    <input type="text" name="portada_pub" class="form-control" id="abrir_archivos" placeholder="Escoga aqui imagen de portada publicación" readonly style="cursor: pointer" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                    <div class="validate"></div>
                  </div>
                ...
                <div class="form-send">
                  <button type="submit" class="btn btn-large btn-primary">Crear publicación</button>
                </div>
