  <?php
  $blog_id = $_SESSION['blog_editar'];
  include_once "application/controllers/admin/archivos/listar_archivos.php";
  include_once "application/controllers/admin/blogs/editar_blog.php";
          ...
          <section class="wrapper">
            <div class="row mt">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="message"></div>
                <form class="contact-form php-mail-form" role="form" action="../controlador_blog/editar_publicacion" method="POST">
                  <?php
                  while ($row = $consultar_blog->fetch()) {
                    echo '
                    <div class="form-group" style="display:none">
                    <input type="name" name="blog_id" class="form-control" value="'.$row['blog_id'].'"  placeholder="id Del programa" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required readonly >
                    <div class="validate"></div>
                    </div>
                    <div class="form-group">
                    <input type="name" name="titulo_pub" class="form-control" value="'.$row['titulo_pub'].'"  placeholder="Titulo de la publicación" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                    </div>
                    <div class="form-group">
                    <input type="name" name="contenido_pub" class="form-control" value="'.$row['contenido_pub'].'"  placeholder="Contenido publicación" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                    </div>

                    <div class="form-group">
                    <input type="text" name="portada_pub" class="form-control" value="'.$row['portada_pub'].'" id="abrir_archivos" placeholder="Escoga aqui la portada para la publicación" readonly style="cursor: pointer" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                    <div class="validate"></div>
                    </div>
                    ';
                  }
                ...
                <div class="form-send">
                  <button type="submit" class="btn btn-large btn-primary">Editar Publicación</button>
                </div>
